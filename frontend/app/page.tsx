...
const Interactive3DElements = dynamic(() => import("@/components/Interactive3DElements"), {
  ssr: false,
});
    ...
    return reports
      ...
      .map((report: any, index: number) => {
        const imageUrl = report.image_metadata?.image_url 
          ...
          : "";
        const dominantEmotions = report.emotional_language?.dominant_emotions || [];
  ...
  useEffect(() => {
    const loadAnalysisImages = async () => {
      try {
        ...
        if (response && response.success && response.reports && Array.isArray(response.reports)) {
        ...
        setGalleryItems([]);
        setGalleryError("분석 이미지를 불러오는 중 오류가 발생했습니다. 잠시 후 다시 시도해주세요.");
      } finally {
        ...
        >
          ...
          >
            ...
            <div className="relative w-[300px] h-[300px] md:w-[400px] md:h-[400px] lg:w-[500px] lg:h-[500px]">
              ...
              <motion.div
                ...
                style={{
                  background: "conic-gradient(from 0deg, rgba(6, 182, 212, 0.3), rgba(59, 130, 246, 0.3), rgba(99, 102, 241, 0.3), rgba(6, 182, 212, 0.3))",
                  filter: "blur(20px)",
                }}
              ...
              <motion.div
                ...
                style={{
                  background: "radial-gradient(circle, rgba(6, 182, 212, 0.4) 0%, rgba(59, 130, 246, 0.3) 50%, rgba(99, 102, 241, 0.2) 100%)",
                  filter: "blur(15px)",
                }}
              ...
              <motion.div
                ...
                style={{
                  boxShadow: "0 0 60px rgba(6, 182, 212, 0.3), inset 0 0 40px rgba(59, 130, 246, 0.2)",
                }}
                animate={{ 
                  rotate: [0, 360],
                  scale: [1, 1.05, 1]
          ...
          >
            ...
            >
              ...
              <br />
              <span className="text-cyan-200">아이의 그림 속 숨겨진 의미를 발견하세요</span>
            </motion.p>
          ...
          <div className="relative">
            {loadingGallery ? (
              ...
              <div className="text-center py-20">
                ...
                <p className="text-slate-600 mb-2 font-medium">{galleryError}</p>
                <p className="text-sm text-slate-500 mb-4">백엔드 서버가 실행 중인지 확인해주세요</p>
                <button
                  onClick={async () => {
              ...
              <div className="text-center py-20">
                ...
                <p className="text-slate-600 mb-2">아직 분석된 이미지가 없습니다</p>
                <Link
                  href="/analysis"
                  className="inline-block mt-4 bg-gradient-to-r from-cyan-500 via-blue-600 to-indigo-600 text-white px-6 py-3 rounded-lg hover:shadow-lg hover:shadow-cyan-500/50 transition-all"
                >
